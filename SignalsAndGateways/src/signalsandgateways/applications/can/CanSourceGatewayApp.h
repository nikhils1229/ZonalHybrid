 ...
 *
 * This module receives CanDataFrames from the gateway and forwards it to the
 * CAN-bus.
 *
...
protected:
   ...
   *
   * If the incoming message is a CanDataFrame, then the CanDataFrame is
   * forwarded to the CAN-bus.
   *
